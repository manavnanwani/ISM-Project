...
//Checking if the attempt 3, or youcan set the no of attempt her. For now we taking only 3fail attempted
if($total_count==10){
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="creditNav">
                        ...
                        <!-- Contact -->
                        <div class="contact">
                            <a href="#"><img src="img/core-img/call2.png" alt=""> +91 9898989898 - CREDIT </a>
                        </div>
                    </nav>
                </div>
            </div>
...
<hr>
    <!-- ##### Services Area Start ###### -->
    <section class="services-area section-padding-100-20" style="padding-top:20px; padding-bottom:20px">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Section Heading -->
    ...
    <!-- ##### Services Area End ###### -->
    <!-- ##### Footer Area Start ##### -->
    <footer class="footer-area section-padding-100-20">
        <div class="container">
            <div class="row">
        ...
        <!-- Copywrite Area -->
        <div class="copywrite-area" style="margin-top:20px">
            <div class="container">
                <div class="row">
                    <div class="col-12">
