			...
			if($temp){
				...
				if($amount>0){
					...
					if($balance>=$amount){
						...
						$success = "Money withdrawn successfully! <br>";
					}else{
                        ...
                        <div class="container">
                            <article class="row">
                                <section class="col-lg-12">
                                    <div class="page-header" style="margin-left:25%">
                                        <h2>Withdraw money</h2>
                                    </div>
                                    <form class="form-horizontal" action="withdrawmoney.php" method="post" role="form" style="margin-left:25%">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                        ...
                                        <a href="admin.php"> <span><< Back to Dashboard</span></a> 
                                        <br><br> 
                                    </div>
                                </section>
                            </article>
